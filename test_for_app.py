...
###############################################
def initial_unet():
    model = "Unet/checkpoints/checkpoint_epoch200.pth"
...
def predict_cluster_for_wound(image_bgr, kmeans_model_path="Hackathon Official Data/Results/kmeans_model.joblib",
